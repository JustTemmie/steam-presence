...
```json
{
	...
	"LOCAL_GAMES": {
		...
		"GAMES": ["processName1", "processName2", "processName3", "so on"]
	},
...
this field can be _anything_ if you want to be seen playing "eirasdtloawbd", or "Hollow knight: Silksong" you can do so.
...
automatic startup is supported by the provided installer scripts on Linux, macOS, and Windows.

# Installation to Automatically Start on Bootup

## Automatic Installer

to install steam presence, run the installer matching your OS.
