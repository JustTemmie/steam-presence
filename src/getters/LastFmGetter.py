...
class LastFmGetter:
    ...
    def fetch(self) -> LastFmFetchPayload:
        ...
        recent_track_baseurl = "https://ws.audioscrobbler.com/2.0/?method=user.getrecenttracks"
        url = f"{recent_track_baseurl}&user={self.username}&api_key={self.api_key}&format=json"
        r = fetch(url)
